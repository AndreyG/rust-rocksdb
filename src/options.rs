...
use rocksdb_ffi;
use mergeoperator::{MergeOperatorCallback, destructor_callback, full_merge_callback, partial_merge_callback, name_callback, MergeOperands};
...
impl RocksDBOptions {
    pub fn new<'a>() -> RocksDBOptions {
        unsafe {
            ...
            let mut block_opts = rocksdb_ffi::rocksdb_block_based_options_create();
